...
Gitlinks pin exact commits; `Ref` names the intended release or update branch.

| Directory | Ref | Description |
| --- | --- | --- |
| `repos/discord.js` | `14.27.0` | Discord clients, gateway events, REST, interactions, and builders. |
| `repos/effect` | `effect@4.0.0-beta.101` | Effect v4 runtime, platform, SQL, testing, and unstable APIs. |
...
| `repos/pi` | `v0.81.1` | Pi agent sessions, resource loading, tools, models, and SDK internals. |
| `repos/t3code` | `main` | Effect patterns for agent lifecycle, process control, SQLite, and services. |
| `repos/typescript-sdk` | `v1.29.0` | MCP transports, protocol types, capabilities, and lifecycle behavior. |
