...
| `repos/effect` | `effect@4.0.0-rc.110` | Effect v4 runtime, platform, SQL, testing, and unstable APIs. |
...
| `repos/pi` | `v0.84.2` | Pi agent sessions, resource loading, tools, models, and SDK internals. |
